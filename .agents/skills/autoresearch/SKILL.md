---
name: autoresearch
description: Use when you want to autonomously optimize a Claude Code skill. The skill will run repeatedly, score outputs against binary evals, mutate the prompt to fix failures, and keep improvements based on Karpathy's autoresearch methodology.
---
