...
| Email signature | `email-signature` | `signature` | n/a |
| Direct introduction | person or connector slug | `introduction` | n/a |
| Speaking appearance | event slug | `speaking` | n/a |
| Job application | company slug | `application` | n/a |
