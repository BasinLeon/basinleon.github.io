...
<div class="intent-grid">
  ...
  <a class="intent-card" href="{{ '/best-of/' | relative_url }}">
    <span class="intent-label">For hiring teams</span>
    <strong>Read the sharpest proof first</strong>
    <p>Use the strongest operator memos to evaluate communication quality, systems thinking, and implementation range quickly.</p>
  </a>
  <a class="intent-card" href="{{ '/frameworks/' | relative_url }}">
    <span class="intent-label">For operators</span>
    <strong>Steal the models, not the slogans</strong>
    <p>Browse the frameworks, decision logic, and anti-slop doctrine that sit underneath the case studies and system builds.</p>
  </a>
</div>
